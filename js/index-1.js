...
function b(){
	...
	img.setAttribute("src","ms.jpg"/*tpa=http://www.flqin.com/demo/js原生demo/images/ms.jpg*/);
	img.setAttribute("id","img_con");
	img.setAttribute("alt","");
	frame.setAttribute("src","frame.gif"/*tpa=http://www.flqin.com/demo/js原生demo/images/frame.gif*/);
	...
	for(var i=0;i<links.length;i++){
		links[i].onmouseover=function(){
			if(this.getAttribute("href").indexOf("index.html"/*tpa=http://www.flqin.com/demo/js原生demo/index.html*/)!=-1)
			move("img_con",0,0,5);
			if(this.getAttribute("href").indexOf("jiqiao.html"/*tpa=http://www.flqin.com/demo/js原生demo/jiqiao.html*/)!=-1)
			move("img_con",-150,0,5);
			if(this.getAttribute("href").indexOf("jineng.html"/*tpa=http://www.flqin.com/demo/js原生demo/jineng.html*/)!=-1)
			move("img_con",-300,0,5);
			if(this.getAttribute("href").indexOf("paihang.html"/*tpa=http://www.flqin.com/demo/js原生demo/paihang.html*/)!=-1)
			move("img_con",-450,0,5);
			if(this.getAttribute("href").indexOf("lianxi.html"/*tpa=http://www.flqin.com/demo/js原生demo/lianxi.html*/)!=-1)
...
function d(){
	...
	p.appendChild(p_txt);
	img.setAttribute("src","placeholder.gif"/*tpa=http://www.flqin.com/demo/js原生demo/images/placeholder.gif*/);
	img.setAttribute("alt","");
